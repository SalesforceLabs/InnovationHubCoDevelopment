({
	...
	gotoIdeas : function(component, event, helper) {
        //?radio=mySubmissions
        helper.navigateToURL(component, event, '/innovation-idea/innohub__Innovation_Idea__c/Recent');
    ...
    gotoDemos : function(component, event, helper) {
        helper.navigateToURL(component, event, '/demo/innohub__Demo__c/Recent?radio=favouriteDemos');
        //helper.setSelectedRadio(component, event, 'Favourite Demos');
	}, 
    
    gotoEvents : function(component, event, helper) {
        helper.navigateToURL(component, event, '/event/innohub__Event__c/Recent?radio=myEvents');
