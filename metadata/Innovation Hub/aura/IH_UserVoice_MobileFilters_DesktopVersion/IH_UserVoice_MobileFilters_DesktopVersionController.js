({
    doInit : function(component, event, helper) {
        console.log('Label 1' + component.get('v.FilterFieldName1'));
        console.log('Label 2' + component.get('v.FilterFieldName2'));
        console.log('Label 3' + component.get('v.FilterFieldName3'));
